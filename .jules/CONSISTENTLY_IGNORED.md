...
**- Justification:** Automated dependency update PRs (#6, #8, #34) are consistently closed/autoclosed. Versions should probably remain pinned or updated manually when needed.
